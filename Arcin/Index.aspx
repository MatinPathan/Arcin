<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Arcin.Index" %>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-5 offset-md-1"> 
          <div class="form_container">
            <form action="">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please entre your Phone Number" ControlToValidate="txtnumber" ForeColor="Red"></asp:RequiredFieldValidator>
                ...
                <div class="btn_box">
                <asp:Button ID="txtbtn" runat="server" Text="Send" CssClass="btn_box" BackColor="#f07b26" />
        ...
        <div class="col-lg-7 col-md-6 px-0">
          <div class="map_container">
            <div class="map">
             <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d13587.056682392451!2d74.6552394034156!3d19.623994090461878!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1693581724231!5m2!1sen!2sin" width="850" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
          </div>
        </div>
      </div>
